...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xEEFF8400;
	private int underlineColor = 0x33FF8400;
	...
	public void notifyDataSetChanged() {
		...
		/*for (int i = 0; i < tabCount; i++) {
			Log.d("taber", "PageAdap: "+pager.getAdapter());
			if (pager.getAdapter() instanceof IconTabProvider) {
				Log.d("taber", "addIcon: "+ i);
				addIconTab(i, ((IconTabProvider) pager.getAdapter()).getPageIconResId(i));
			} else {
				Log.d("taber", "addText: "+ pager.getAdapter().getPageTitle(i).toString());
		...
		addIconTab(3, R.drawable.ic_action_settings);
